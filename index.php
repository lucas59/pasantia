            ...
            <div class="modal-content" style="margin-top: 18%;">
                ...
                <div class="modal-body centrar">
                    <div class="centrar row">
                        <div class="col-xs-6">
                            <div class="well">
                                <form id="loginForm" action="Vistas/colocarVolquetas.php" method="POST">
                                    <div class="form-group">
                                        <label for="username" class="control-label">Cedula</label>
                                        <input type="text" name="login" id="inputEmail" class="form-control" placeholder="Cedula..." required autofocus>
                                    ...
                                    <button style="background-color: #287AE6; color : white"  class="btn btn-block">Iniciar Sesión</button>
                                </form>
                            </div>
                        </div>
                    </div>
